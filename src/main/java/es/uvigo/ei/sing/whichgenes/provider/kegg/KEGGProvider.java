...
public class KEGGProvider extends AbstractGeneSetProvider {

	private String specie;
	public KEGGProvider(String specie) {
		super("KEGG Pathway");
		super.setDescription("Genes involved in KEGG Pathways");
		this.specie = specie;
	}

	public Query newQuery() {
		return new KEGGQuery(this, this.specie);
	}
